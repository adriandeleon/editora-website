...
import {
  commandGroups as commandGroups_0_18_1,
  keymaps as keymaps_0_18_1,
} from "./commands-archive/v0-18-1";
import {
  commandGroups as commandGroups_0_18_0,
  keymaps as keymaps_0_18_0,
} from "./commands-archive/v0-18-0";
import {
  commandGroups as commandGroups_0_17_0,
  keymaps as keymaps_0_17_0,
} from "./commands-archive/v0-17-0";
import {
  commandGroups as commandGroups_0_16_0,
  keymaps as keymaps_0_16_0,
} from "./commands-archive/v0-16-0";
import {
  commandGroups as commandGroups_0_15_0,
  keymaps as keymaps_0_15_0,
} from "./commands-archive/v0-15-0";
import {
  commandGroups as commandGroups_0_14_0,
  keymaps as keymaps_0_14_0,
} from "./commands-archive/v0-14-0";
import {
...
import {
  commandGroups as commandGroups_0_12_0,
  keymaps as keymaps_0_12_0,
} from "./commands-archive/v0-12-0";
import {
  commandGroups as commandGroups_0_11_0,
  keymaps as keymaps_0_11_0,
} from "./commands-archive/v0-11-0";
import {
...
const ARCHIVED: Spec[] = [
  {
    version: "0.18.2",
    archive: "0.18.2",
    commandGroups: commandGroups_0_18_2,
    keymaps: keymaps_0_18_2,
  },
  {
    version: "0.18.1",
    archive: "0.18.1",
    commandGroups: commandGroups_0_18_1,
    keymaps: keymaps_0_18_1,
  },
  {
    version: "0.18.0",
    archive: "0.18.0",
    commandGroups: commandGroups_0_18_0,
    keymaps: keymaps_0_18_0,
  },
  {
    version: "0.17.0",
    archive: "0.17.0",
    commandGroups: commandGroups_0_17_0,
    keymaps: keymaps_0_17_0,
  },
  {
    version: "0.16.0",
    archive: "0.16.0",
    commandGroups: commandGroups_0_16_0,
    keymaps: keymaps_0_16_0,
  },
  {
    version: "0.15.0",
    archive: "0.15.0",
    commandGroups: commandGroups_0_15_0,
    keymaps: keymaps_0_15_0,
  },
  {
    version: "0.14.0",
    archive: "0.14.0",
    commandGroups: commandGroups_0_14_0,
    keymaps: keymaps_0_14_0,
  },
  {
    version: "0.13.1",
    archive: "0.13.1",
  ...
  },
  {
    version: "0.13.0",
    archive: "0.13.0",
    commandGroups: commandGroups_0_13_0,
    keymaps: keymaps_0_13_0,
  },
  {
    version: "0.12.3",
    archive: "0.12.3",
  ...
  // links resolving instead of 404ing. Same commands: 0.12.2 added none.
  {
    version: "0.12.2",
    archive: "0.12.2",
    commandGroups: commandGroups_0_12_1,
    keymaps: keymaps_0_12_1,
  },
  {
    version: "0.12.1",
    archive: "0.12.1",
  ...
  },
  {
    version: "0.12.0",
    archive: "0.12.0",
    commandGroups: commandGroups_0_12_0,
    keymaps: keymaps_0_12_0,
  },
  {
    version: "0.11.0",
    archive: "0.11.0",
    commandGroups: commandGroups_0_11_0,
    keymaps: keymaps_0_11_0,
  },
  {
    version: "0.10.0",
    archive: "0.10.0",
