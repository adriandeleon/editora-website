...
## A tiny server, on loopback only

When you click the globe on an HTML file, Editora starts a small web server using
the JDK's built-in `HttpServer`, bound to `127.0.0.1:0` — **loopback only**, a
