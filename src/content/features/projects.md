...
order: 1
beta: false
summary: "Explore a project as a file tree or a <strong>spatial canvas</strong>: focused columns, pan and zoom, four flow directions, live filters, and a floating code preview — all navigable from the keyboard."
---
